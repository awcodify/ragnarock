...
class MetricsAnalyzer:
    ...
    def _format_metrics(self, raw_metrics: List[Dict]) -> List[Dict]:
        ...
        for metric_group in raw_metrics:
            try:
                ...
                latest_values = metric_data["values"][
                    -1
                ]  # Get last timestamp-value pair
    ...
    async def analyze_query(self, query: str) -> Dict:
        ...
        current_metrics = {
            m["metric"]: {"value": m["value"], "timestamp": m["timestamp"]}
        ...
        similar_patterns = {
            m["metric_name"]: {"value": m["value"], "timestamp": m["timestamp"]}
            for m in similar
        }
